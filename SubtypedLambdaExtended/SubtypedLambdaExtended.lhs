...
basic language to include integers and integer sum, difference,
product and quotient.  In addition, we will add definitions for tuples
and projections from tuples. The definition of the abstract syntax
provides the following forms for $\lambda_\rightarrow$ terms, values
and types:
...
%include SubtypedLambdaExtendedAST.lhs

%include SubtypedLambdaExtendedEnv.lhs

%include SubtypedLambdaExtendedTypesT.lhs

%include SubtypedLambdaExtendedEval.lhs

%include SubtypedLambdaExtendedInterpreter.lhs
