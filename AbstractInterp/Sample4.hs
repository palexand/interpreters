-- Implements a simple language embedded in the simple resumption
-- monad, ResT
...
type ValueMonad = (ResT (StateT Env (Reader Gamma))) Value
...
--  runReader (runStateT (runResT (eval termX)) []) []
