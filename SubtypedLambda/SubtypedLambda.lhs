...
\begin{eqnarray*}
  ...
  v & \isa & \lambda x:T.t \ora \TRUE \ora \FALSE \\
  T & \isa & \BOOL \ora T \rightarrow T \ora \{l_0:T_0,l_1:T_1...l_n:T_n\}
\end{eqnarray*}
...
\[\vcenter{\infer[\textsc{E-Record}]
	{\{l_1=v_1,l_2=v_2,...,l_n=t,l_{n+1}=v_{n+1},...,l_{n+k}=v_{n+k}\}
	\longrightarrow
	\{l_1=v_1,l_2=v_2,...,l_n=t',l_{n+1}=v_{n+1},...,l_{n+k}=v_{n+k}\}}
	{t\longrightarrow t'}}
\]

\[\vcenter{\infer[\textsc{E-Reference}]
	{\{l_1=v_1,l_2=v_2,...,l_k=v_k,...,l_n=v_n\}.l_k \longrightarrow v_k\}}
	{}
\]
...
\[\vcenter{\infer[\textsc{T-Record}]
	{\Gamma\vdash \{l_1=t_1,l_2=t_2,...,l_n=t_n\}:\{l_1:T_1,l_2:T_2,...,l_n:T_n\}}
	{\Gamma\vdash t_1:T_1 & \Gamma\vdash t_2:T_2 & ... & \Gamma\vdash t_n:T_n}}
\]

\[\vcenter{\infer[\textsc{E-Reference}]
	{\{l_1=v_1,l_2=v_2,...,l_k=v_k,...,l_n=v_n\}.l_k:T_k\}}
	{\{l_1=v_1,l_2=v_2,...,l_k=v_k,...,l_n=v_n\}:\{l_1:T_1,l_2:T_2,...,l_k:T_k,...,l_n:T_n\}}
\]
